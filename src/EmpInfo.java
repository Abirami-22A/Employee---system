...
public class EmpInfo extends javax.swing.JFrame {
    ...
    public void Connect()
    {
        ...
        try {
            ...
            Logger.getLogger(EmpInfo.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void table_update(){
        int CC;
        try {
            pst = con.prepareStatement("SELECT * FROM emprecords");
    ...
    private void initComponents() {
        ...
        txtFname.setFont(new java.awt.Font("Segoe UI Semibold", 1, 14)); // NOI18N
        txtFname.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 0, 51), 1, true));
        ...
        txtLname.setFont(new java.awt.Font("Segoe UI Semibold", 1, 14)); // NOI18N
        txtLname.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 0, 51), 1, true));
        ...
        txtContact.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 0, 51), 1, true));

        txtCity.setFont(new java.awt.Font("Segoe UI Semibold", 1, 14)); // NOI18N
        txtCity.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 0, 51), 1, true));
        ...
        txtSalary.setFont(new java.awt.Font("Segoe UI Semibold", 1, 14)); // NOI18N
        txtSalary.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 0, 51), 1, true));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            pst = con.prepareStatement("insert into emprecords (fname,lname,city,contact,salary)values(?,?,?,?,?)");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            pst = con.prepareStatement("update emprecords set fname=?,lname=?,city=?,contact=?,salary=? where id =?");
            pst.setString(1,fname);
            pst.setString(2,lname);
            pst.setString(3,city);
            pst.setString(4,contact);
